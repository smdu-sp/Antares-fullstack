...
/** Espelha services/unidades/query-functions/listar-autocomplete.ts, pra unidades-grupo (por grupo). */
export async function listarAutocomplete(
  ...
  try {
    ...
    const resposta = await fetch(`${BACKEND}unidades-grupo/lista-completa${query}`, {
