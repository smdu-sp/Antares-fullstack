...
/** Espelha services/unidades/query-functions/lista-completa.ts, pra unidades-grupo (por grupo). */
export async function listaCompleta(
  ...
  try {
    const unidades = await fetch(`${baseURL}unidades-grupo/lista-completa`, {
      method: "GET",
