...
import { contarAtrasados } from '@/lib/server/processos/contar-atrasados';

export const runtime = 'nodejs';

/** Porte de ProcessosController.contarAtrasados (GET /processos/contar/atrasados). */
export async function GET(request: NextRequest) {
  try {
    ...
    const total = await contarAtrasados(usuario.id);
