...
import { contarVencendoHoje } from '@/lib/server/processos/contar-vencendo-hoje';

export const runtime = 'nodejs';

/** Porte de ProcessosController.contarVencendoHoje (GET /processos/contar/vencendo-hoje). */
